Com certeza. Baseado no `docker-compose.yml` e nos arquivos `package.json` do seu projeto, aqui está uma versão melhorada do `README.md` com as instruções completas de instalação e execução.
