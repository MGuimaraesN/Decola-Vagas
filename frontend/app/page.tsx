              ...
              <div className="flex flex-col md:flex-row gap-2 items-center">
                ...
                <div className="relative flex-1 w-full">
                    ...
                    <Input
                        ...
                        // High Contrast: bg-transparent, text-white, placeholder-slate-400
                ...
                <div className="h-8 w-px bg-slate-800 hidden md:block" /> {/* Divisor Vertical */}
...
// --- MODAL DE LOGIN ATUALIZADO (DARK & LEGÍVEL) ---
...
// Componente Card de Vaga (Dark Theme Refined)
...
// Componente Card de Feature (Dark Theme Refined)
